...
def generate_readme():
    ...
    template = env.get_template('basic_readme.txt')
...
for label_text, var_name in fields:
    ...
    entries[var_name] = tk.Entry(frame, width=50)
    entries[var_name].pack(side="left")
...
generate_btn = tk.Button(root, text="Generate README", command=generate_readme)
